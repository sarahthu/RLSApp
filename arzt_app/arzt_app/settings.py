"""
Django settings for arzt_app project.
...
BASE_DIR = Path(__file__).resolve().parent.parent  #Pfad zum Django Projektverzeichnis (arzt_app)
...
SECRET_KEY = 'django-insecure-qfq4-u6kq6@rx8=g4huqgy6tp9u*cx8*6(cf2bsw%@n+s_iy2w'
...
WSGI_APPLICATION = 'arzt_app.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR / 'db.sqlite3',   #Datenbank wird im arzt_app Verzeichnis erstellt
    }
}
